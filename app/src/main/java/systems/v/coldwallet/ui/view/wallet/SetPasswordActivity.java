...
import systems.v.coldwallet.databinding.ActivitySetPasswordBinding;
...
public class SetPasswordActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        mColorStrength1 = ContextCompat.getColor(this, R.color.password_strength1);
        mColorStrength2 = ContextCompat.getColor(this, R.color.password_strength2);
        mColorStrength3 = ContextCompat.getColor(this, R.color.password_strength3);
        mColorStrength4 = ContextCompat.getColor(this, R.color.password_strength4);
        mColorStrength5 = ContextCompat.getColor(this, R.color.password_strength5);
        mBaseColor = ContextCompat.getColor(this, R.color.text_weak);
        if (TextUtils.isEmpty(mSeed)) {
            mBinding.tvCreateOrSet.setText(getString(R.string.wallet_create));
        } else {
            mBinding.tvCreateOrSet.setText(getString(R.string.wallet_set_password));
        }
    }
